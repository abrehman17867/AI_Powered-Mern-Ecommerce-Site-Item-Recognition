...
// Applied immediately on a quantity tap so the UI moves before the network
// does; the server's returned cart reconciles it a moment later.
export const SET_CART_ITEM_QUANTITY_OPTIMISTIC="SET_CART_ITEM_QUANTITY_OPTIMISTIC"
